from exercicios_6 import Livro

"""No arquivo biblioteca.py, 
empreste o livro chamando o método emprestar e 
...
"""No arquivo biblioteca.py, 
utilize o método estático verificar_disponibilidade para obter a 
lista de livros disponíveis publicados em um ano específico."""
